    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_location', models.JSONField(blank=True, default=list, null=True)),
                ('preferred_position', models.JSONField(blank=True, default=list, null=True)),
                ('desired_salary', models.TextField(blank=True, null=True)),
