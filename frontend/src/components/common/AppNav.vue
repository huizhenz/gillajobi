  ...
  <div class="nav-wrap">
    <nav class="navbar">
      <div class="nav-left">
        ...
        <router-link :to="{ name: 'JobView' }" class="nav-link">채용공고</router-link>
        <router-link :to="{ name: 'CertificationView' }" class="nav-link">자격증</router-link>
        <router-link :to="{ name: 'BootcampView' }" class="nav-link">부트캠프</router-link>
        <router-link :to="{ name: 'CompetitionView' }" class="nav-link">공모전</router-link>
        <router-link :to="{ name: 'CommunityView' }" class="nav-link">커뮤니티</router-link>
      </div>
